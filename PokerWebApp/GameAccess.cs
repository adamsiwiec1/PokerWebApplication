...
namespace PokerWebApp
{
    public class GameAccess
    {
        ...
        public static DataTable GetAllPlayerCards()
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "spGetAllPlayerCards";
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public static void UpdateCards(Card card1)
        {
            ...
            //command object
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "spUpdateCard";
            cmd.CommandType = System.Data.CommandType.StoredProcedure;


            SqlParameter param = new SqlParameter("@Card1", card1);
